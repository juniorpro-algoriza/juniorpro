...
const HomePage = () => {
  return (
    <main className="px-4">
      ...
      <h1 className="text-5xl leading-[120%] font-semibold text-semi-blue text-center pt-[89px] xl:w-[660px] mx-auto">
        Connecting Juniorpros with exciting digital products.
      </h1>
      <p className="font-medium text-shadowBlue text-center text-2xl pt-5">
      ...
      <section className="pt-[72px] flex justify-center">
        <div className="relative">
          <Input
            ...
            className="drop-shadow-blue-alpha drop-shadow-md rounded-4xl w-[60vw] xl:w-[42vw] placeholder-storm-500 py-5"
          />
          <Button
            intent="primary"
            className="absolute right-0 top-0 mt-2 mr-2 rounded-4xl xl:w-[118px] bg-unitedBlue py-3.5 px-6"
          >
            Find Now
          </Button>
        </div>
      ...
      <section className="pt-20 flex justify-center flex-col gap-3.5">
        ...
        <p className="font-bold text-5xl text-center text-muted-text">
          How JuniorPro Works
        </p>
      </section>
      <section className="pt-36 flex flex-col xl:flex-row justify-center gap-28">
        <div>
          ...
          <p className="font-bold text-5xl leading-14 xl:w-[521px] text-muted-text">
            Start building your skills with our collection of free solo projects
          </p>
          <p className="w-[521px] font-lg text-muted-text pt-4">
            Build your tech skills by completing at least 5 free solo projects.
            These beginner-friendly tasks are your first step into the world of
            technology.
          </p>
            ...
            {heroSteps.map((step, index) => {
              return (
                <div
                  key={step}
                  className={twMerge(
                    "w-full xl:w-fit relative py-6 px-5 rounded-2xl bg-white drop-shadow-2xl flex gap-2.5",
                    index % 2 === 0 ? "xl:mr-auto" : "xl:ml-auto"
                  )}
                >
                  <div className="absolute -right-[10px] -top-[5px] xl:-right-[20px] xl:-top-[10px] flex flex-col justify-center items-center bg-light-red px-2 py-1 rounded-lg text-xs">
                    <span className="text-bright-red">{index + 1}</span>
