...
export const StuckOnAProblem = () => {
  return (
    <div className="mt-10 xl:max-w-4/5">
      <MainCard classname="border border-gray-100 flex items-center justify-between gap-3 flex-wrap">
        <div className="flex items-center gap-5">
          <div className="min-w-14 size-14 bg-gray-50 flex items-center justify-center rounded-full">
            <CircleQuestionMark />
          </div>
          <div>
            <h3 className="font-bold md:text-lg text-base">Stuck on a problem?</h3>
