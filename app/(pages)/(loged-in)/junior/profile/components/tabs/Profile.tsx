    ...
    <div className='flex gap-6 py-6'>
      ...
      <div className='bg-white rounded-2xl shadow-xl space-y-3 p-6 h-fit w-1/3'>
        ...
        <p className='text-content-secondary font-medium leading-8'>
          I'm a passionate junior developer who loves building web applications.
          I enjoy learning new technologies and am always looking for challenges
          to improve my skills through code.
        </p>
