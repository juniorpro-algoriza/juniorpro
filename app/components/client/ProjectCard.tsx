...
export const ProjectCard = ({
  ...
  return (
    <MainCard
      classname={cx(
        "relative flex flex-col h-full border-blue-main/30 shadow-main rounded-3xl cursor-pointer hover:shadow-lg transition-shadow p-5 md:p-6",
        className
      )}
    >
      {/* Header */}
      ...
      <div className="mt-auto">
        ...
        >
          {isLocked ? (
            <span className="flex items-center gap-2">{lockLabel}</span>
          ) : (
            buttonText
          )}
        </Button>
