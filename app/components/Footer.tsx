        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-24">
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-4 text-white/70">
              <li><Link href="#" className="hover:text-pink-main transition-colors">Features</Link></li>
              <li><Link href="#" className="hover:text-pink-main transition-colors">Missions</Link></li>
              <li><Link href="#" className="hover:text-pink-main transition-colors">Pricing</Link></li>
              <li><Link href="#" className="hover:text-pink-main transition-colors">For Schools</Link></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-4 text-white/70">
              <li><Link href="#" className="hover:text-pink-main transition-colors">For Kids</Link></li>
              <li><Link href="#" className="hover:text-pink-main transition-colors">For Parents</Link></li>
              <li><Link href="#" className="hover:text-pink-main transition-colors">For Teachers</Link></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-4 text-white/70">
              <li><Link href="#" className="hover:text-pink-main transition-colors">Blog</Link></li>
              <li><Link href="#" className="hover:text-pink-main transition-colors">Help Center</Link></li>
              <li><Link href="#" className="hover:text-pink-main transition-colors">Community</Link></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-6 lg:col-span-5 lg:col-start-8">
            ...
            <p className="text-white/70 mb-6">
              Join our newsletter to stay up to date on new missions and features.
            </p>
