...
interface EditContributorProfileProps {
  contributorId?: number;
  onUpdated?: (updated: ContributorProfile) => void;
  onClose?: () => void;
}

export const EditContributorProfile = ({
  onUpdated,
  onClose,
}: EditContributorProfileProps) => {
  ...
  const handleChange = (field: keyof ContributorProfile, value: string) => {
