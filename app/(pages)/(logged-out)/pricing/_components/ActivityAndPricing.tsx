...
import { Rocket, Building, Heart, Sparkles, Check, DollarSign } from 'lucide-react';
...
export function ActivityAndPricing() {
  ...
  return (
    <div id="pricing" className="min-h-screen relative overflow-hidden font-sans text-black">
      <div className="relative z-10 container mx-auto px-6 py-32 max-w-7xl">
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 px-6 py-3 bg-white rounded-full border-[3px] border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] mb-8 transform hover:scale-105 hover:-rotate-2 transition-transform">
            ...
            <span className="text-sm tracking-wide font-black text-black uppercase">Flexible Plans</span>
          </div>

          {/* Main Heading */}
          <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tight text-black drop-shadow-sm leading-[1.1]">
            Predictable & Simple<br />Pricing.
          </h1>

          {/* Subheading */}
          <p className="text-xl md:text-2xl text-[#1F3D8B] font-bold leading-relaxed max-w-3xl mx-auto">
            Support their learning, boost their confidence, and guide them through Missions, Collaborations, and Challenges.
          </p>
        </motion.div>
          ...
          {pricingPlans.map((plan, index) => (
            ...
            >
              ...
              >
                ...
                <div className={`absolute top-0 left-0 right-0 h-32 opacity-30 ${plan.bgPattern}`} />
                ...
                <div className="relative z-10 mb-6 flex justify-center">
                  ...
                  >
                    <plan.icon className="text-black size-9" strokeWidth={2.5} />
                  </div>
                </div>
                ...
                <div className="text-center mb-6 relative z-10">
                  ...
                  <div className="flex items-center justify-center gap-1 mb-4">
                    ...
                    <span className="text-sm font-bold text-black/60">SAR/mo</span>
                  </div>
                ...
                <div className="space-y-3 mb-8 flex-grow relative z-10">
                  {plan.features.map((feature, i) => (
                    <div key={i} className="flex items-start gap-3 text-sm">
                      ...
                      <span className="text-black font-bold leading-tight">{feature}</span>
                    </div>
                  ))}
                </div>
  ...
  const pricingPlans = [
    {
      ...
      description: 'Start your Junior\'s journey with Missions and a 7-day trial of the Growth Plan.',
      icon: Rocket,
      capacity: '1 Junior',
      price: '0',
    ...
    },
    {
      ...
      bgPattern: "bg-[linear-gradient(45deg,#f3f4f6_25%,transparent_25%,transparent_75%,#f3f4f6_75%,#f3f4f6),linear-gradient(45deg,#f3f4f6_25%,transparent_25%,transparent_75%,#f3f4f6_75%,#f3f4f6)] [background-position:0_0,10px_10px] [background-size:20px_20px]",
      features: [
    ...
    },
    {
      ...
      bgPattern: "bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-gray-100 via-transparent to-transparent",
      features: [
